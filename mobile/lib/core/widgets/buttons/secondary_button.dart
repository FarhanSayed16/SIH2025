/// Phase 101.2: Secondary Button Component
/// A secondary button with lighter background for secondary actions

import 'package:flutter/material.dart';
import '../../design/design_system.dart';
import 'primary_button.dart'; // For ButtonSize enum

/// Secondary Button - Secondary action button with lighter background
class SecondaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bgColor = backgroundColor ?? AppColors.primaryGreenLight;
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          disabledBackgroundColor: AppColors.backgroundMedium,
